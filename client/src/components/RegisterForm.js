  ...
  return (
    <div className="col-lg-6">
      ...
      <div className="row px-3 mb- mt-4">
        <h2 className="mb-0 mr-4 mt-2">Tạo tài khoản</h2>
      </div>
      {message && (
        <div
      ...
      <div className="col text-left">
        <div className="custom-control custom-checkbox">
          <input
            ...
            onClick={() => setRequire({ ...require, checkbox: !require.checkbox })}
            required
          />
          <label for="my-input" className="custom-control-label">
            <a
              ...
              target="_blank"
            >
              <u className="text-primary">Bạn đồng ý với các điều khoản & dịch vụ của chúng tôi</u>
            </a>
          </label>
        </div>
      </div>
      ...
      <div className="row mb-4 px-3">
        <small className="font-weight-bold d-flex">
          Đã có tài khoản?          
          <Link to="/login">
            <p className="text-danger ml-1">Đăng kí</p>
          </Link>
        </small>
      </div>
    </div>
